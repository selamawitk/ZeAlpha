...
import { addGift, getGifts, getGiftById, getDigitalCard, toggleLock, unlockGift, getWeddingRegistry, getGiftRecommendations, getSurgingGifts, updateGiftSettlement, updateGift, deleteGift, createGuestGift, approveGuestGift, getPendingGuestGifts, updateGiftDelivery } from '../controllers/giftController.js';
...
router.route('/:id/toggle-lock').post(optionalProtect, toggleLock);
